        ...
        <div class="card-body">
            <div class="card">
                <div class="card-body card-block">
                    <form  role="form" action="/pbd3/query/tambahuser.php" method="post" class="" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="exampleFormControlInput1">Nama user</label>
                            <input type="text" class="form-control" name="nm_user">
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlInput1">Singkatan user</label>
                            <input type="text" class="form-control" name="sk_user">
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-1">
                                <a href="/pbd3/admin/user.php" class="btn btn-secondary">Kembali</a>
                            </div>
                        </div>
                    </form>
                </div>

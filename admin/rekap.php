...
<div class="letak">
    <div >
        <table  class="table-sm" >
            ...
            if(isset($_GET['cari'])){
                $cari = $_GET['cari'];
                $sql = pg_query("select distinct informasi_pelaporan.id_pelaporan,informasi_pelaporan.no_tiket,
                                            informasi_pelaporan.nama_pengguna,informasi_pelaporan.kontak_pengguna,
                                            informasi_pelaporan.media_pelaporan,informasi_pelaporan.deskripsi,
                                            informasi_pelaporan.waktu_pelaporan,informasi_pelaporan.status,
                                            ...
                                            join petugas on detail_petugas.id_petugas=petugas.id_petugas where cast(tanggal_penyelesaian as text) like '%".$cari."%' 
                                            and status = 'difasilitasi'");
            }else{
